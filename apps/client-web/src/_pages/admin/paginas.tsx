    ...
    const load = async () => {
      ...
      try {
        ...
        if (sectionsRes.ok === false)
          throw new Error(sectionsRes.error || "No se pudo cargar el CMS");
        if (plansRes.ok === false)
          throw new Error(plansRes.error || "No se pudieron cargar los planes");
  ...
  return (
    <>
      ...
      >
        ...
        {loading && (
          <p style={{ color: "#555" }}>Cargando secciones y planes...</p>
        )}
        ...
        >
          ...
          <p style={{ margin: 0, color: "#555" }}>
            Para modificar planes desde el panel administrativo necesitas el
            mismo token configurado en el backend (variable{" "}
            <code>ADMIN_TOKEN</code>). Escribilo manualmente: nunca lo publiques
            en el frontend.
          </p>
          <input
            type="text"
        ...
        {!loading && (
          <>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                ...
                <tbody>
                  {sections.map((section) => (
                    ...
                    >
                      <td
                        style={{ padding: "12px", color: "var(--primary-700)" }}
                      >
                        {section.name}
                      </td>
            ...
            >
              ...
              <p style={{ margin: 0, color: "#555" }}>
                Estos planes se muestran en la landing y en /planes. Ajusta
                valores y comisiones segn estrategia.
              </p>
              <div style={{ display: "grid", gap: "18px" }}>
                  ...
                  >
                    ...
                    <label style={{ display: "grid", gap: 4 }}>
                      ...
                      <input
                        ...
                        value={plan.leadFee}
                        onChange={(e) =>
                          handlePlanChange(plan.id, "leadFee", e.target.value)
                        }
                        style={{
                          width: "100%",
                          padding: "10px 12px",
                ...
                {plans.length === 0 && (
                  <p style={{ color: "#777" }}>No hay planes configurados.</p>
                )}
              </div>
            </section>
          </>
