    ...
    const load = async () => {
      ...
      try {
        ...
        if (!res.ok || payload.ok === false)
          throw new Error(payload.error || "No se pudo obtener el prestador");
        setData(payload);
      } catch (err) {
          ...
          <>
            ...
            >
              ...
              <p style={{ margin: 0, color: "#555" }}>
                Prestador verificado en OficiosYa.
              </p>
              {areas.length > 0 ? (
                ...
                <p style={{ color: "#777" }}>
                  El prestador aún no declaró zonas de trabajo.
                </p>
              )}
              <div style={{ display: "flex", gap: 18, flexWrap: "wrap" }}>
                <span>
                  <strong>Calificaciones:</strong> próximamente
                </span>
                <span>
                  <strong>Miembro desde:</strong>{" "}
                  {new Date(
                    data.provider.createdAt || Date.now(),
            ...
            >
              ...
              <p style={{ color: "#555" }}>
                Estados de validación visibles para generar confianza en los
                clientes.
              </p>
              <div
                style={{
            ...
            >
              <div>
                ...
                <p style={{ color: "#555" }}>
                  Seleccioná el servicio que necesitás. Podrás coordinar fecha y
                ...
                {services.map((srv) => (
                  ...
                  >
                    ...
                    >
                      <div>
                        <h3 style={{ margin: 0 }}>
                          {srv.catalog?.nombre || "Servicio"}
                        </h3>
                        <p style={{ margin: 0, color: "#666" }}>
                          {srv.catalog?.rubro}
                          {srv.catalog?.subrubro
                            ? ` (${srv.catalog?.subrubro})`
                            : ""}
                        </p>
                    ...
                    {srv.estimatedDuration ? (
                      <small style={{ color: "#777" }}>
                        Tiempo estimado: {srv.estimatedDuration} minutos
                      </small>
                    ) : null}
                    <div
                      style={{
            ...
            >
              ...
              <p style={{ color: "#777" }}>
                Próximamente podrás ver fotos confirmadas por clientes y
