...
const timeline = [
  {
    time: "09:12",
    action: "OficiosYa notifico la aprobacion de terminos version 1.0.3",
  },
  {
    time: "10:04",
    action:
      "Lucia Pereyra subio evidencia final del trabajo y solicitaste liberacion de fondos",
  },
  {
    time: "11:20",
    action:
      "Nuevo presupuesto recibido para Pintura integral - pendiente de aprobacion",
  },
];
