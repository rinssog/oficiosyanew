...
export default function AdminTermsPage() {
  ...
  return (
    <div>
      ...
      <NavBar />
      <main
        style={{ maxWidth: 920, margin: "32px auto", padding: "0 16px 64px" }}
      >
        <h1>Editar términos y condiciones</h1>
        <p>
          Ingresá el token administrativo para modificar la versión vigente del
          documento.
        </p>
        <form
        ...
        {message && (
          <p style={{ color: "#2e7d32", marginTop: 16 }}>{message}</p>
        )}
