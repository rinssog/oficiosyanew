    ...
    <>
      ...
      >
        ...
        <section style={{ background: "#fff", borderRadius: "22px", border: "1px solid var(--border)", padding: "24px", display: "grid", gap: "12px" }}>
          <h2 style={{ margin: 0, fontSize: "1.3rem", color: "var(--primary-700)" }}>Notas</h2>
          <p style={{ margin: 0, color: "var(--text-soft)" }}>
            En la implementacion real integraremos estos indicadores con el motor de reglas y el sistema de auditoria. Cada reporte
            podra exportarse a CSV y programarse por correo para administradores master.
          </p>
        </section>
      </DashboardShell>
      <Footer />
