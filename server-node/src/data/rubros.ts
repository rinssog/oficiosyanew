/**
 * rubros.ts — Catálogo completo OficiosYa
 * 27 rubros, 13 categorías, 130+ servicios
 */
export interface Servicio {
  id: string; nombre: string; descripcion: string;
  urgenciaDisponible: boolean; requiereMatricula: boolean;
}
export interface Rubro {
  id: string; nombre: string; icon: string; color: string;
  categoria: string; servicios: Servicio[];
}
...
export const RUBROS_COMPLETOS: Rubro[] = [
  { id:"albanileria", nombre:"Albañilería", icon:"🏗️", color:"#78716C", categoria:"Construcción", servicios:[
    ...
    {id:"alb-5",nombre:"Colocación de cerámicos y porcelanato",descripcion:"Pisos y paredes",urgenciaDisponible:false,requiereMatricula:false},
  ]},
  { id:"pintura", nombre:"Pintura", icon:"🖌️", color:"#7C3AED", categoria:"Construcción", servicios:[
    ...
    {id:"pin-5",nombre:"Laqueado de muebles",descripcion:"Laca en madera y MDF",urgenciaDisponible:false,requiereMatricula:false},
  ]},
  { id:"carpinteria", nombre:"Carpintería", icon:"🪚", color:"#92400E", categoria:"Construcción", servicios:[
    ...
    {id:"car-3",nombre:"Colocación de pisos de madera",descripcion:"Parquet, machimbre y laminados",urgenciaDisponible:false,requiereMatricula:false},
  ...
  { id:"herreria", nombre:"Herrería y Metalúrgica", icon:"⚙️", color:"#374151", categoria:"Construcción", servicios:[
    ...
    {id:"her-3",nombre:"Soldadura",descripcion:"MIG/TIG para reparaciones",urgenciaDisponible:false,requiereMatricula:false},
  ...
  { id:"techista", nombre:"Techista", icon:"🏠", color:"#B45309", categoria:"Construcción", servicios:[
    {id:"tec-h1",nombre:"Reparación de tejas y chapas",descripcion:"Goteras y reemplazo",urgenciaDisponible:true,requiereMatricula:false},
    {id:"tec-h2",nombre:"Colocación de chapas",descripcion:"Zinc y galvanizada",urgenciaDisponible:false,requiereMatricula:false},
    {id:"tec-h3",nombre:"Cielorrasos",descripcion:"Durlock, yeso y PVC",urgenciaDisponible:false,requiereMatricula:false},
    {id:"tec-h4",nombre:"Impermeabilización de techos",descripcion:"Membrana y poliuretano",urgenciaDisponible:false,requiereMatricula:false},
  ]},
  { id:"vidrieria", nombre:"Vidriería", icon:"🔲", color:"#0891B2", categoria:"Construcción", servicios:[
    {id:"vid-1",nombre:"Colocación de vidrios",descripcion:"Ventanas y puertas",urgenciaDisponible:true,requiereMatricula:false},
    ...
    {id:"vid-3",nombre:"Mamparas de baño",descripcion:"Box de ducha",urgenciaDisponible:false,requiereMatricula:false},
    {id:"vid-4",nombre:"Espejos",descripcion:"Colocación de espejos",urgenciaDisponible:false,requiereMatricula:false},
  ]},
  { id:"electricidad", nombre:"Electricista", icon:"⚡", color:"#D97706", categoria:"Instalaciones", servicios:[
    ...
    {id:"ele-4",nombre:"Domótica y automatización",descripcion:"Llaves inteligentes",urgenciaDisponible:false,requiereMatricula:true},
    ...
    {id:"ele-6",nombre:"Generadores y UPS",descripcion:"Sistemas de respaldo",urgenciaDisponible:true,requiereMatricula:true},
  ]},
  { id:"plomeria", nombre:"Plomería", icon:"🔧", color:"#0284C7", categoria:"Instalaciones", servicios:[
    {id:"plo-1",nombre:"Destapaciones",descripcion:"Cañerías y desagotes",urgenciaDisponible:true,requiereMatricula:false},
    ...
    {id:"plo-5",nombre:"Sistemas de riego",descripcion:"Riego automático",urgenciaDisponible:false,requiereMatricula:false},
  ]},
  { id:"gas", nombre:"Gasista", icon:"🔥", color:"#DC2626", categoria:"Instalaciones", servicios:[
    {id:"gas-1",nombre:"Instalación de gas natural",descripcion:"Habilitación y extensión",urgenciaDisponible:true,requiereMatricula:true},
    ...
    {id:"gas-4",nombre:"Certificado GAS para alquiler",descripcion:"Habilitación y certificado",urgenciaDisponible:false,requiereMatricula:true},
  ...
  { id:"climatizacion", nombre:"Climatización", icon:"❄️", color:"#0891B2", categoria:"Instalaciones", servicios:[
    ...
    {id:"cli-2",nombre:"Mantenimiento de AA",descripcion:"Filtros y carga de gas",urgenciaDisponible:false,requiereMatricula:true},
    ...
    {id:"cli-4",nombre:"Estufas y caloventores",descripcion:"Instalación",urgenciaDisponible:false,requiereMatricula:false},
    {id:"cli-5",nombre:"Campanas y ventilación",descripcion:"Extractor y sistemas",urgenciaDisponible:false,requiereMatricula:false},
  ]},
  { id:"cerrajeria", nombre:"Cerrajería", icon:"🔑", color:"#4338CA", categoria:"Seguridad", servicios:[
    {id:"cer-1",nombre:"Apertura de emergencia",descripcion:"Sin daño",urgenciaDisponible:true,requiereMatricula:false},
    ...
    {id:"cer-4",nombre:"Cerraduras electrónicas",descripcion:"Smart locks",urgenciaDisponible:false,requiereMatricula:false},
    {id:"cer-5",nombre:"Cajas fuertes",descripcion:"Apertura y anclaje",urgenciaDisponible:true,requiereMatricula:false},
  ]},
  { id:"alarmas", nombre:"Alarmas y CCTV", icon:"📷", color:"#1D4ED8", categoria:"Seguridad", servicios:[
    ...
    {id:"ala-3",nombre:"Control de acceso",descripcion:"RFID y biometría",urgenciaDisponible:false,requiereMatricula:false},
    {id:"ala-4",nombre:"Porteros y videoporteros",descripcion:"Instalación",urgenciaDisponible:false,requiereMatricula:false},
  ]},
  { id:"jardineria", nombre:"Jardinería", icon:"🌿", color:"#16A34A", categoria:"Jardín", servicios:[
    ...
    {id:"jar-2",nombre:"Mantenimiento mensual",descripcion:"Corte, podas y limpieza",urgenciaDisponible:false,requiereMatricula:false},
  ...
  { id:"paisajista", nombre:"Paisajista", icon:"🌳", color:"#15803D", categoria:"Jardín", servicios:[
    {id:"pai-1",nombre:"Diseño paisajístico integral",descripcion:"Proyecto completo",urgenciaDisponible:false,requiereMatricula:false},
    {id:"pai-2",nombre:"Jardines verticales",descripcion:"Muros verdes",urgenciaDisponible:false,requiereMatricula:false},
    {id:"pai-3",nombre:"Diseño de terrazas y balcones",descripcion:"Deck y canteros",urgenciaDisponible:false,requiereMatricula:false},
    {id:"pai-4",nombre:"Asesoría en plantas",descripcion:"Selección y cuidado",urgenciaDisponible:false,requiereMatricula:false},
  ]},
  { id:"poda-altura", nombre:"Poda en Altura", icon:"🌲", color:"#166534", categoria:"Jardín", servicios:[
    ...
    {id:"pod-2",nombre:"Extracción de árboles",descripcion:"Tala controlada",urgenciaDisponible:false,requiereMatricula:false},
    {id:"pod-3",nombre:"Poda de palmeras",descripcion:"Limpieza y mantenimiento",urgenciaDisponible:false,requiereMatricula:false},
    {id:"pod-4",nombre:"Extracción de tocones",descripcion:"Fresado",urgenciaDisponible:false,requiereMatricula:false},
  ]},
  { id:"piletero", nombre:"Piletero", icon:"🏊", color:"#0284C7", categoria:"Jardín", servicios:[
    {id:"pil-1",nombre:"Mantenimiento semanal",descripcion:"Química, limpieza y succión",urgenciaDisponible:false,requiereMatricula:false},
    {id:"pil-2",nombre:"Apertura de temporada",descripcion:"Preparación verano",urgenciaDisponible:false,requiereMatricula:false},
    {id:"pil-3",nombre:"Cierre de temporada",descripcion:"Conservación invierno",urgenciaDisponible:false,requiereMatricula:false},
  ...
  { id:"tecnologia", nombre:"Técnico Informático", icon:"💻", color:"#6366F1", categoria:"Tecnología", servicios:[
    ...
    {id:"ti-5",nombre:"Smart TV y dispositivos",descripcion:"Configuración de smart TVs",urgenciaDisponible:false,requiereMatricula:false},
  ]},
  { id:"redes", nombre:"Redes y Cableado", icon:"🌐", color:"#0891B2", categoria:"Tecnología", servicios:[
    {id:"red-1",nombre:"Cableado estructurado",descripcion:"Redes de datos empresariales",urgenciaDisponible:false,requiereMatricula:false},
    {id:"red-2",nombre:"Fibra óptica",descripcion:"Empalme y tendido",urgenciaDisponible:false,requiereMatricula:false},
    {id:"red-3",nombre:"CCTV y redes IP",descripcion:"Cableado de cámaras",urgenciaDisponible:false,requiereMatricula:false},
  ]},
  { id:"electrodomesticos", nombre:"Técnico en Electrodomésticos", icon:"🔌", color:"#0369A1", categoria:"Electrodomésticos", servicios:[
    ...
    {id:"ed-4",nombre:"Hornos y cocinas",descripcion:"Eléctricos y microondas",urgenciaDisponible:false,requiereMatricula:false},
    {id:"ed-5",nombre:"Pequeños electrodomésticos",descripcion:"Planchas y aspiradoras",urgenciaDisponible:false,requiereMatricula:false},
  ]},
  { id:"limpieza", nombre:"Limpieza del Hogar", icon:"🧹", color:"#0891B2", categoria:"Limpieza", servicios:[
    ...
    {id:"lim-2",nombre:"Limpieza post-obra",descripcion:"Con retiro de escombros",urgenciaDisponible:false,requiereMatricula:false},
    {id:"lim-3",nombre:"Limpieza de oficinas",descripcion:"Espacios de trabajo",urgenciaDisponible:false,requiereMatricula:false},
    {id:"lim-4",nombre:"Limpieza fin de mudanza",descripcion:"Antes o después de mudarse",urgenciaDisponible:false,requiereMatricula:false},
  ]},
  { id:"fumigacion", nombre:"Fumigación", icon:"🐛", color:"#65A30D", categoria:"Limpieza", servicios:[
    ...
    {id:"fum-3",nombre:"Desinfección completa",descripcion:"Nebulización",urgenciaDisponible:false,requiereMatricula:true},
  ...
  { id:"lavado-tapizados", nombre:"Lavado de Tapizados", icon:"🛋️", color:"#7C3AED", categoria:"Limpieza", servicios:[
    ...
    {id:"tap-2",nombre:"Sillones y sofás",descripcion:"Lavado profundo",urgenciaDisponible:false,requiereMatricula:false},
    {id:"tap-3",nombre:"Colchones",descripcion:"Aspirado y desodorizado",urgenciaDisponible:false,requiereMatricula:false},
    {id:"tap-4",nombre:"Cortinas",descripcion:"Seco sin descolgarlas",urgenciaDisponible:false,requiereMatricula:false},
  ]},
  ...
  { id:"flete", nombre:"Flete y Cadetería", icon:"📦", color:"#B45309", categoria:"Logística", servicios:[
    ...
    {id:"fle-4",nombre:"Materiales de obra",descripcion:"Arena, piedras y materiales",urgenciaDisponible:false,requiereMatricula:false},
  ]},
  { id:"mecanica", nombre:"Mecánico a Domicilio", icon:"🚗", color:"#374151", categoria:"Automotor", servicios:[
    {id:"mec-1",nombre:"Diagnóstico electrónico",descripcion:"Escaneo OBD",urgenciaDisponible:true,requiereMatricula:false},
    ...
    {id:"mec-4",nombre:"Frenos y neumáticos",descripcion:"Pastillas y cubiertas",urgenciaDisponible:false,requiereMatricula:false},
  ...
  { id:"cerrajeria-auto", nombre:"Cerrajero de Autos", icon:"🚘", color:"#4338CA", categoria:"Automotor", servicios:[
    ...
    {id:"ca-3",nombre:"Programación de transponder",descripcion:"Inmovilizador",urgenciaDisponible:false,requiereMatricula:false},
  ]},
  { id:"enfermeria", nombre:"Enfermería a Domicilio", icon:"🩺", color:"#0891B2", categoria:"Salud", servicios:[
    {id:"enf-1",nombre:"Inyectables y sueros",descripcion:"A domicilio",urgenciaDisponible:true,requiereMatricula:true},
    {id:"enf-2",nombre:"Cuidado de adultos mayores",descripcion:"Acompañamiento",urgenciaDisponible:false,requiereMatricula:true},
    {id:"enf-3",nombre:"Curación de heridas",descripcion:"Heridas quirúrgicas",urgenciaDisponible:false,requiereMatricula:true},
    {id:"enf-4",nombre:"Kinesiología",descripcion:"Rehabilitación física",urgenciaDisponible:false,requiereMatricula:true},
  ]},
  { id:"veterinaria", nombre:"Veterinaria a Domicilio", icon:"🐾", color:"#65A30D", categoria:"Salud", servicios:[
    ...
    {id:"vet-2",nombre:"Vacunación y desparasitación",descripcion:"Plan sanitario",urgenciaDisponible:false,requiereMatricula:true},
    {id:"vet-3",nombre:"Peluquería canina",descripcion:"Baño, corte y estética",urgenciaDisponible:false,requiereMatricula:false},
    {id:"vet-4",nombre:"Paseador de perros",descripcion:"Individual o grupal",urgenciaDisponible:false,requiereMatricula:false},
  ]},
  { id:"fotografo", nombre:"Fotógrafo / Videógrafo", icon:"📸", color:"#7C3AED", categoria:"Eventos", servicios:[
    {id:"foto-1",nombre:"Fotografía de eventos",descripcion:"Casamientos y corporativos",urgenciaDisponible:false,requiereMatricula:false},
    {id:"foto-2",nombre:"Fotografía inmobiliaria",descripcion:"Para publicaciones",urgenciaDisponible:false,requiereMatricula:false},
    {id:"foto-3",nombre:"Video corporativo",descripcion:"Institucionales",urgenciaDisponible:false,requiereMatricula:false},
  ...
  { id:"planchado-costura", nombre:"Planchado y Costura", icon:"👗", color:"#DB2777", categoria:"Otros", servicios:[
    ...
    {id:"cos-2",nombre:"Arreglos de ropa",descripcion:"Ruedos y entallados",urgenciaDisponible:false,requiereMatricula:false},
...
export const RUBROS_DESTACADOS = [
  ...
  {id:"paisajista",  nombre:"Paisajista",      icon:"🌳"},
  {id:"poda-altura", nombre:"Poda en Altura",  icon:"🌲"},
  {id:"mudanzas",    nombre:"Mudanzas",        icon:"🚛"},
  {id:"flete",       nombre:"Flete / Cadete",  icon:"📦"},
...
export const CATEGORIAS = [
  "Construcción","Instalaciones","Seguridad","Jardín","Tecnología",
  "Electrodomésticos","Limpieza","Logística","Automotor","Salud",
  "Eventos","Servicios profesionales","Otros",
];
